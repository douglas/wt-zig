...
pub const all = [_]Spec{
    ...
    .{
        ...
        .usage = "wt cleanup [--dry-run] [--force|-f]",
        .details = "Find linked worktrees whose branches are merged into the default base branch, preview them with --dry-run, confirm removals in text mode, or remove them all with --force.",
    },
    .{
        .kind = .migrate,
        .name = "migrate",
